...
<!--header start-->
    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-file-text-o"></i> Input Data</h3>
...
<form action="aksi.php" method="post" enctype="multipart/form-data">
                <div align="left" valign="top">
                    ...
                    <?php } ?>
                                ...
                                <label>
                                    <input type="checkbox" name="<?php echo $noatribut[$i]?>" id="optionsRadios1" value="y">
         ...
         <div class="form-group" style="margin-left: 40px;padding-bottom: 20px;">
                        <button type="submit" name="upload" value="Upload" class="btn btn-primary">Input</button>
                     </div>
      </form>
